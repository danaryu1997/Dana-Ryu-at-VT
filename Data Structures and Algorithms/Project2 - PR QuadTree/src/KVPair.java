...
public class KVPair<K extends Comparable<? super K>, V> implements
    Comparable<KVPair<K, V>> {
    ...
    /**
     * Determines if two KV pair are equal
     * @param pair2 pair comparing
     * @return true if equal
     */
    public boolean equal(KVPair<K, V> pair2) {
        return pair2.getKey().equals(key) && pair2.getValue().equals(value);
    }
}
